    ...
    def train_and_test(self, n_epoch=100):
        ...
        while epoch < n_epoch:
            ...
            for batch_index in range(int(self.n_train_batches)):
                ...
                for batch_index in range(int(self.n_test_batches)):
                ...
                print('counter#{}  epoch: {}, test mean loss={}, test accuracy={}'.format(counter, epoch, loss, accuracy))
                print('')
                counter += 1
        return accuracies
...
if __name__ == '__main__':
    ...
    print("Char-Scnn successfully ended")
